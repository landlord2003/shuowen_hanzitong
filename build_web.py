...
lines.append('.evo-step .era-img{width:64px;height:64px;object-fit:contain;display:block;margin:0 auto;background:#fff;border:1px solid #555;border-radius:4px}')
...
js_parts.append('    if (d[i]) { img.data[i*4]=30; img.data[i*4+1]=30; img.data[i*4+2]=30; img.data[i*4+3]=255; }')
js_parts.append('    else { img.data[i*4]=255; img.data[i*4+1]=255; img.data[i*4+2]=255; img.data[i*4+3]=255; }')
js_parts.append('  }')
