...
lines.append('<p class="sub">510字·甲骨文到简体演变·字形来源·本地字形数据集（EVOBC · CC BY-NC-SA 4.0）</p>')
...
lines.append('<div class="src-legend"><h3>数据来源与说明</h3><ul><li><b>说文原文 / 反切 / 段玉裁注 / 异体重文</b>：出自《说文解字》（东汉·许慎），含清代段玉裁注</li><li><b>后起字溯源</b>：出自《玉篇》（543年）、《广韵》（1008年）、《康熙字典》（1716年）。《康熙字典》为集大成字书，整合历代韵书反切与释义；《玉篇》《广韵》年代更早，可定位更早的字义</li><li><b class="warn">⚠️ 音译字提示</b>：部分字古字书释义与今义不同——如「啡」古为「唾声」非「咖啡」、「吨」古为「气相冲」非重量单位、「她」古为「姐」非第三人称。此类已在溯源中单独标注</li><li><b>字形演变图</b>：出自 EVOBC 数据集（CC BY-NC-SA 4.0，非商业用途）</li><li><b>六书 / 本义 / 今义 / 演变</b>：AI 生成，待核验</li><li><b>五行属性</b>：民俗归类（字源五行法），非文字学客观属性；依「字义＞偏旁」判定并标注出处，约 44% 字（人体、动作、抽象、虚词等）无明确归属</li></ul></div>')
lines.append('<div class="footer">字形来源：本地字形集（EVOBC · CC BY-NC-SA 4.0）｜说文解字汉字知识库</div>')
...
js_parts.append('    "</div>" +')
js_parts.append('    "<div class=\'detail-section\'><h4>' + u('字形演变') + '</h4><i class=\'src-mini\'>' + u('出：EVOBC字形数据集（CC BY-NC-SA 4.0）') + '</i>" + noteHTML + "<div class=\'evo-timeline\'>" + evoHTML + "</div></div>" +')
