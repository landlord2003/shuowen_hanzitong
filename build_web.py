...
lines.append('<p class="sub">8105字·甲骨文到简体演变·字形来源·中央研究院漢字構形資料庫（CC BY-SA 2.5 TW）</p>')
...
js_parts.append('  var order = ["oracle-bone","bronze","bamboo-silk","seal","clerical","regular"];')
...
js_parts.append('    "</div>" +')
js_parts.append('    "<div class=\'detail-section\'><h4>' + u('字形演变') + '</h4><i class=\'src-mini\'>' + u('出：中央研究院漢字構形資料庫（CC BY-SA 2.5 TW）') + '</i>" + noteHTML + "<div class=\'evo-timeline\'>" + evoHTML + "</div></div>" +')
