...
js_parts.append(r'''    if (s.pending) { return arrow + "<div class='evo-step pending'><div class='era-name'>" + s.era + "</div>" + (ERA_DESC[s.era] ? "<div class='era-desc pending-desc'>" + ERA_DESC[s.era] + "</div>" : "") + "<div class='era-pending'>" + "\u5f85\u8865\u5168" + "</div></div>"; }''')
